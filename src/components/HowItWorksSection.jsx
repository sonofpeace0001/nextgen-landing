...
const STEPS = [
  { n: "01", title: "Join free", desc: "Sign up, tell us where you are starting from. No experience needed." },
  { n: "02", title: "Pick your path", desc: 'Graphics, content, apps, or "not sure yet". You can change your mind.' },
  { n: "03", title: "Get your first win", desc: "Make something real with AI in about ten minutes. Rough drafts welcome." },
  { n: "04", title: "Keep building", desc: "Daily challenges, people to ask, and a path that goes as deep as you want." },
];
        ...
        {STEPS.map((step, i) => (
          <FadeUp key={step.n} delay={i * 80}>
            <div className="border-t border-border pt-5">
              <div className="text-2xl font-semibold text-muted-foreground">{step.n}</div>
