    ...
    <section id="academy" className="ng-section" style={{ padding: "104px 0" }}>
      <div style={{ maxWidth: 1120, margin: "0 auto", padding: "0 24px" }}>
        ...
        <p style={{ fontSize: 17, lineHeight: 1.6, color: "var(--muted-foreground)", maxWidth: 600, marginBottom: 48 }}>
          Every path starts with a short Foundations course, then runs from Basic to Grandmaster. Each ends with something real you made, scored with clear feedback.
        </p>
